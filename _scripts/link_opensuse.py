...
dotfiles_symlink('wlogout', '.config/wlogout')
dotfiles_symlink('kvantum', '.config/Kvantum')
dotfiles_symlink('swaync', '.config/swaync')
dotfiles_symlink('btop/themes', '.config/btop/themes')
dotfiles_symlink('icons', '.local/share/icons')

dotfiles_symlink("btop/btop.conf", ".config/btop/btop.conf")
dotfiles_symlink('fzf/rose-pine.sh', '.local/bin/fzf/rose-pine.sh')
dotfiles_symlink('bin/wofi-emoji', '.local/bin/wofi-emoji')
dotfiles_symlink('starship/starship.toml', '.config/starship.toml')
