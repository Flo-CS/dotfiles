...
with_sudo backup /etc/snapper/configs/root
...
log_section "Grub-Btrfs Config"
with_sudo backup /etc/default/grub-btrfs/config
with_sudo insert_with_marker /etc/default/grub-btrfs/config "custom" "GRUB_BTRFS_SNAPSHOT_KERNEL_PARAMETERS=\"rd.live.overlay.overlayfs=1\""
