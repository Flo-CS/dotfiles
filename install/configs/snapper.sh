...
sudo create_backup /etc/snapper/configs/root
...
sudo create_backup /etc/default/grub-btrfs/config
sudo insert_content_with_marker /etc/default/grub-btrfs/config "custom" "GRUB_BTRFS_SNAPSHOT_KERNEL_PARAMETERS=\"rd.live.overlay.overlayfs=1\""
